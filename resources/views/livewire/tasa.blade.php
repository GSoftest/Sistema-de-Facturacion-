    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
                ...
                <div class="pt-8 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="tasa" id="tasa" wire:model='tasa' autocomplete="given-name" maxlength="5" placeholder="0,00" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="py-4">
        ...
        <table class="w-full border">
         ...
         <div class="mt-4">
            ...
            <div class="py-4">
                <p class="text-sm text-red-600">Nota: Al activar una tasa se desactiva automáticamente la de BCV. <br>Si todas las tasa están desactivadas la tasa BCV queda activa por defecto.</p>
            </div>
