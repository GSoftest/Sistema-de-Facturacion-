                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="py-2 grid grid-cols-2 gap-4 justify-items-stretc">
                            <div>
                                ...
                                <input type="text" name="telefono" id="telefono" wire:model='telefono' maxlength="12" autocomplete="given-telefono" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                       ...
                       <div class="py-2 grid grid-cols-2 gap-4 justify-items-stretc">
                        ...
                        <div class="flex justify-center py-2 font-light px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="pt-3.5">
                                <a href="/clientes" class="bg-red-500 hover:bg-red-700 text-white font-bold px-2 mt-2 border border-red-500 rounded py-1.5">Cancelar</a>
                            </div>
                        </div>  
                    </div>
                    </form>
