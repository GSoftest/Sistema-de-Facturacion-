                    ...
                    <div class="grid grid-cols-1 gap-1  justify-items-stretc">
                        ...
                        <div class="py-2 grid grid-cols-4 gap-4 justify-items-stretc">
                            <div>
                                ...
                                <input type="text" name="telefono" id="telefono" wire:model='telefono' value="{{$data->telefono}}"  autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> 
                            </div>
                        </div>
